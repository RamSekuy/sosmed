...
export default function Home() {
  for (let i = 0; i < recomendedPeople.length; i++) {
    recomendedPeople[i] = {
      ...
      postImgs: ["https://th.bing.com/th/id/OIP.QIW1lKgrtrspQv8luNDugQHaEK?rs=1&pid=ImgDetMain","https://th.bing.com/th/id/OIP.QIW1lKgrtrspQv8luNDugQHaEK?rs=1&pid=ImgDetMain"],
      likes: i*100,
  ...
  <div className="w-full sticky top-0 md:hidden bg-white z-10">
  ...
  <main className="min-h-screen w-full">
    <div className="lg:hidden w-full">
      <div className="w-full overflow-hidden flex justify-start border-y-2 border-solid border-grey-300">
          <div className=" bg-gray-200 md:mb-3 p-2 max-w-full min-w-full overflow-auto flex gap-3 no-scrollbar">
            <StoryList/>
          </div>
      </div>
    </div>
      ...
      <div className=" flex justify-center">
        ...
        <section className="hidden lg:block xl:pl-[64px] pl-8">
          <div className="max-w-[319px] min-w-[319px] max-h[287px] mt-9">
            ...
            <footer className="w-full text-gray-400 m-2">
    ...
    <div className="w-full">
      ...
      <div className="h-full flex">
        <div className="h-full rounded-full overflow-hidden aspect-square relative">
          <Image className="object-cover" src={profileImgUrl} alt="profile-img" fill={true} sizes="100%"/>
        </div>
        ...
        <h6 className="h-[50%] p-0 m-0 text-gray-500">{realName}</h6>
        </div>
      </div>
        {/* Button Alihkan */}
